...
class ConversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation" do
    assert_difference('Conversation.count') do
      post conversations_url, params: { conversation: { name: @conversation.name, user_id: @conversation.user_id } }
    end
  ...
  test "should update conversation" do
    patch conversation_url(@conversation), params: { conversation: { name: @conversation.name, user_id: @conversation.user_id } }
